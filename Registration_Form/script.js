...
//     const gender1 = document.querySelectorAll('input[name="gender"]');
//     for(const br of gender1)
//     {
//         if(br.checked)
//         {
//             gender = br.value;
...
//     for( const br of skill1)
//     {
//         if(br.checked)
//         {
//             skills.push(br.value);
...
//  //function to print the data on right side

//  function printResult(data)
//  {
//     const result1 = document.getElementById("enrolled-student");
...
//     result1.append(wrapper);
//   } else {
//     result1.append(sectionHeading, wrapper)
//   };
